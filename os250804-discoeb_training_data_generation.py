...
Pks = []
for i in range(10):
    print(f"Running batch {i}, simulations #{1000*i} to #{1000*(i + 1) - 1}.")
    cosmo_params_batch = cosmo_params_samples[1000*i:1000*(i + 1)]
    Pk_in_Mpc_h_batch, kmodes_in_Mpc_h = compute_matter_power_batched(cosmo_params_batch)
