...
def _derivative(weights, h_params,
    ...
    return np.log(10) * jax.jacfwd(forward_pass, argnums=2)(weights, h_params, parameters_arr)
...
def MSE_Sobolev(weights, h_params, data, _lambda=1.0):
...
def TrainModelInBatches(training_parameters,
                        training_features,
    ...
    def update(weights, h_params, opt_state, hyper_opt_state, data, learning_rate):
        ...
        loss, gradients = value_and_grad(MSE, argnums = 0)(weights, h_params, data)
        gradients1 = grad(MSE, argnums = 1)(weights, h_params, data)
    ...
    def training_step(weights,
        ...
        for batch in batches:
            ...
            X_batch, Y_batch = training_parameters[start:end], training_features[start:end]    
